from diffusers import (
    StableDiffusionBrushNetPipeline, BrushNetModel, UniPCMultistepScheduler,
    StableDiffusionInpaintPipeline, StableDiffusionXLInpaintPipeline,
    FluxFillPipeline, AutoPipelineForInpainting
)
import torch
import cv2
import json
...
parser.add_argument('--model_name', type=str, default="brushnet", help="Model to evaluate")
...
MODELS = {
    "stable-diffusion-v1-5/stable-diffusion-inpainting": {
        "path": "/home/admin/workspace/aop_lab/app_data/.cache/models--stable-diffusion-v1-5--stable-diffusion-inpainting/snapshots/8a4288a76071f7280aedbdb3253bdb9e9d5d84bb",
        "pipeline_class": StableDiffusionInpaintPipeline,
        "dtype": torch.float16
    },
    "black-forest-labs/FLUX.1-Fill-dev": {
        "path": "/home/admin/workspace/aop_lab/app_data/.cache/models--black-forest-labs--FLUX.1-Fill-dev/snapshots/6d92c296315be5f54318a6d2659f11465339f934",
        "pipeline_class": FluxFillPipeline,
        "dtype": torch.bfloat16
    },
    "diffusers/stable-diffusion-xl-1.0-inpainting-0.1": {
        "path": "/home/admin/workspace/aop_lab/app_data/.cache/models--diffusers--stable-diffusion-xl-1.0-inpainting-0.1/snapshots/115134f363124c53c7d878647567d04daf26e41e",
        "pipeline_class": StableDiffusionXLInpaintPipeline,
        "dtype": torch.float16
    },
    "JunhaoZhuang/PowerPaint-v2-1": {
        "path": "/home/admin/workspace/aop_lab/app_data/.cache/models--JunhaoZhuang--PowerPaint-v2-1/snapshots/5ae2be3ac38b162df209b7ad5de036d339081e33",
        "pipeline_class": StableDiffusionInpaintPipeline,
        "dtype": torch.float16
    },
    ...
    "kd5678/prefpaint-v1.0": {
        "path": "kd5678/prefpaint-v1.0",
        "pipeline_class": AutoPipelineForInpainting,
        "dtype": torch.float16
    }
}
...
if args.model_name == "brushnet":
    ...
    print(f"Loading model: {args.model_name} from {config['path']}")
    try:
        ...
        if "flux" in args.model_name.lower():
             # Flux models are large, offload to CPU
             pipe.enable_model_cpu_offload()
    ...
    print(f"Model {args.model_name} not found. Available models: {list(MODELS.keys())} + ['brushnet']")
    exit(1)
...
for key, item in mapping_file.items():
    ...
    if args.model_name == "brushnet":
        ...
        # Flux Fill and others might behave slightly differently but standard diffusers API 
        # usually unifies this. 
